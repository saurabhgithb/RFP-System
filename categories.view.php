                                ...
                                <div class="card-body">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-9 text-right">
                                                <div class="headerButtons">
                                                    <a href="add-categories.php" class="btn btn-sm btn-success "><i class="mdi mdi-plus"></i> Add Categories</a>
                                                </div>
                                            </div>
                                        ...
                                        <table class="table mb-0 listingData dt-responsive" id="datatable">
                                            ...
                                            <tbody>
                                                ...
                                                if (mysqli_num_rows($category_list_result) > 0) {
                                                    ...
                                                    while ($categoryRow = mysqli_fetch_array($category_list_result)) {
                                                ...
                                                ?>
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <?php
                                                                if (strtolower($categoryRow['status']) == "active") { ?>
                                                            ...
                                                            <td>
                                                                ...
                                                                ?>
                                                                    <a href="categories.php?category_id=<?php echo $categoryRow['category_id']; ?>&action=deactivate" class="text-danger">Deactivate</a>
                                                                <?php } else { ?>
                                                                    <a href="categories.php?category_id=<?php echo $categoryRow['category_id']; ?>&action=activate" class="text-success">Activate</a>
                                                                <?php }
                                                                ?>
                                                            </td>
                                                        </tr>
                                    ...
                                    <div class="row pt-3">
                                        <div class="col-sm-12 col-md-5">
                                            ...
                                            $lastColumnNumber = min($firstColumnNumber + $results_per_page - 1, $no_of_categories);
                                            ?>
                                            <div class="dataTables_info" id="datatable_info" role="status" aria-live="polite">Showing <?php echo ($no_of_categories == 0) ? "0" : $firstColumnNumber ?> to <?php echo $lastColumnNumber; ?> of <?php echo $no_of_categories; ?> entries</div>
                                        </div>
                                            ...
                                            <div class="dataTables_paginate paging_simple_numbers" id="datatable_paginate">
                                                <ul class="pagination">
                                                    <li class="paginate_button page-item previous <?php if ($current_page <= 1) echo 'disabled'; ?>" id="datatable_previous">
                                                        <a href="categories.php?page=<?php if ($current_page <= 1) {
                                                                                            echo $no_of_pages;
                                                                                        } else {
                                                                                            echo $current_page - 1;
                                                                                        }
                                                    ...
                                                    ?>
                                                        <li class="paginate_button page-item <?php if ($page == $current_page) echo 'active'; ?>">
                                                            <a href="categories.php?page=<?php echo $page; ?>" aria-controls="datatable" data-dt-idx="1" tabindex="0" class="page-link"><?php echo $page; ?></a>
                                                        </li>
                                                    <?php } ?>
                                                    <li class="paginate_button page-item next <?php if (($current_page + 1) > $no_of_pages) echo 'disabled'; ?>" id="datatable_next"><a href="categories.php?page=<?php if ($current_page >= $no_of_pages) {
                                                                                                                                                                                                                        echo 1;
                                                                                                                                                                                                                    } else {
                                                                                                                                                                                                                        echo $current_page + 1;
