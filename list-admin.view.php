                                ...
                                <div class="card-body">
                                    ...
                                    <div class="table-responsive">
                                        <table class="table mb-0 listingData dt-responsive" id="datatable">
                                            ...
                                            <tbody>
                                                <?php
                                                if (mysqli_num_rows($admins_list_result) > 0) {
                                                    $counter = $starting_row_number + 1;

                                                    while ($adminRow = mysqli_fetch_array($admins_list_result)) {

                                                ?>
                                                        <tr>
                                                            <th scope="row"><?php echo $counter++; ?></th>
                                                            <th scope="row"><?php echo $adminRow["user_id"]; ?></th>
                                                            <td><?php echo $adminRow["first_name"]; ?></td>
                                                            <td><?php echo $adminRow["last_name"]; ?></td>
                                                            <td><?php echo $adminRow["email"]; ?></td>
                                                            <td>
                                                                <?php
                                                                if (strtolower($adminRow['status']) == "approved") { ?>
                                                    ...
                                                    <tr>
                                                        <th scope="row">No Admins found in the system.</th>
                                                    </tr>
                                    ...
                                    <div class="row pt-3">
                                        <div class="col-sm-12 col-md-5">
                                            ...
                                            $lastColumnNumber = min($firstColumnNumber + $results_per_page - 1, $no_of_admins);
                                            ?>
                                            <div class="dataTables_info" id="datatable_info" role="status" aria-live="polite">Showing <?php echo ($no_of_admins == 0) ? "0" : $firstColumnNumber; ?> to <?php echo $lastColumnNumber; ?> of <?php echo $no_of_admins; ?> entries</div>
                                        </div>
                                            ...
                                            <div class="dataTables_paginate paging_simple_numbers" id="datatable_paginate">
                                                <ul class="pagination">
                                                    <li class="paginate_button page-item previous <?php if ($current_page <= 1) echo 'disabled'; ?>" id="datatable_previous">
                                                        <a href="list-admin.php?page=<?php if ($current_page <= 1) {
                                                                                            echo $no_of_pages;
                                                                                        } else {
                                                                                            echo $current_page - 1;
                                                                                        }
                                                    ...
                                                    ?>
                                                        <li class="paginate_button page-item <?php if ($page == $current_page) echo 'active'; ?>">
                                                            <a href="list-admin.php?page=<?php echo $page; ?>" aria-controls="datatable" data-dt-idx="1" tabindex="0" class="page-link"><?php echo $page; ?></a>
                                                        </li>
                                                    <?php } ?>
                                                    <li class="paginate_button page-item next <?php if (($current_page + 1) > $no_of_pages) echo 'disabled'; ?>" id="datatable_next"><a href="list-admin.php?page=<?php if ($current_page >= $no_of_pages) {
                                                                                                                                                                                                                        echo 1;
                                                                                                                                                                                                                    } else {
                                                                                                                                                                                                                        echo $current_page + 1;
