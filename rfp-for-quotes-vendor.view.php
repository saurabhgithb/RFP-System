                                ...
                                <div class="card-body">
                                    ...
                                    <div class="table-responsive">
                                        <table class="table mb-0 listingData dt-responsive" id="datatable">
                                            ...
                                            <tbody>
                                                <?php
                                                if (isset($vendor_id) && mysqli_num_rows($rfp_list_result) > 0) {
                                                ...
                                                ?>
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <?php
                                                                if (strtolower($rfpRow['status']) == 'open') {
                                                                    // check if vendor has submitted quote for the rfp
                                                                    $checkQuoteResponse = quoteExist($rfpRow["rfp_id"], $vendor_id);
                                                                    if (isset($checkQuoteResponse) && $checkQuoteResponse['quote_found']) {
                                                                        $quoteId = $checkQuoteResponse["quote_data"]["quote_id"];
                                                                ?>
                                                                        <a href="view-quote.php?quoteId=<?php echo $quoteId; ?>" title="View Quote" class="text-success">View Quote</a>
                                                                    <?php
                                                                    } else { ?>
                                                                        <a href="create-quote.php?rfpId=<?php echo $rfpRow["rfp_id"]; ?>" title="Apply" class="text-primary">Apply</a>
