                                ...
                                <div class="card-body">
                                    ...
                                    <div class="table-responsive">
                                        <table class="table mb-0 listingData dt-responsive" id="datatable">
                                            ...
                                            <tbody>
                                                <?php
                                                if (mysqli_num_rows($quotes_list_result) > 0) {
                                                ...
                                                ?>
                                                    ...
                                                    <tr>
                                                        <th scope="row">No Quotes found in the system.</th>
                                                    </tr>
                                    ...
                                    <div class="row pt-3">
                                        <div class="col-sm-12 col-md-5">
                                            ...
                                            $lastColumnNumber = min($firstColumnNumber + $results_per_page - 1, $no_of_quotes);
                                            ?>
                                            <div class="dataTables_info" id="datatable_info" role="status" aria-live="polite">Showing <?php echo ($no_of_quotes == 0) ? "0" : $firstColumnNumber; ?> to <?php echo $lastColumnNumber; ?> of <?php echo $no_of_quotes; ?> entries</div>
                                        </div>
                                            ...
                                            <div class="dataTables_paginate paging_simple_numbers" id="datatable_paginate">
                                                <ul class="pagination">
                                                    <li class="paginate_button page-item previous <?php if ($current_page <= 1) echo 'disabled'; ?>" id="datatable_previous">
                                                        <a href="rfp-quotes.php?page=<?php if ($current_page <= 1) {
                                                                                            echo $no_of_pages;
                                                                                        } else {
                                                                                            echo $current_page - 1;
                                                                                        }
                                                    ...
                                                    ?>
                                                        <li class="paginate_button page-item <?php if ($page == $current_page) echo 'active'; ?>">
                                                            <a href="rfp-quotes.php?page=<?php echo $page; ?>" aria-controls="datatable" data-dt-idx="1" tabindex="0" class="page-link"><?php echo $page; ?></a>
                                                        </li>
                                                    <?php } ?>
                                                    <li class="paginate_button page-item next <?php if (($current_page + 1) > $no_of_pages) echo 'disabled'; ?>" id="datatable_next"><a href="rfp-quotes.php?page=<?php if ($current_page >= $no_of_pages) {
                                                                                                                                                                                                                        echo 1;
                                                                                                                                                                                                                    } else {
                                                                                                                                                                                                                        echo $current_page + 1;
