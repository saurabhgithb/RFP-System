...
// check if edit vendor error is set
if (!empty($_SESSION['edit-vendor-error'])) {
    $formErrors[] = $_SESSION['edit-vendor-error'];
    unset($_SESSION['edit-vendor-error']);
}
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="mt-4 text-center">
                                        <a href="register-admin.php" class="text-primary"><i class="mdi mdi-lock mr-1"></i> Register new Admin</a>
                                    </div>
                                </div>
                            </div>
                        </div>
